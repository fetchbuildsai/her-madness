    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#71717a] text-sm">Create your free account</p>
        </div>

        {/* Google first — highest conversion */}
        <motion.button
        ...
        <div className="bg-[#111113] border border-white/[0.08] rounded-3xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-[#71717a] mb-1.5 uppercase tracking-wide">Username</label>
              <input name="username" type="text" placeholder="hoopsfan22" required minLength={3} maxLength={20}
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input name="newsletter" type="checkbox" defaultChecked
                className="mt-0.5 w-4 h-4 rounded border-white/20 bg-[#09090b] accent-[#d4a017]" />
              <span className="text-xs text-[#52525b] leading-relaxed">
                Subscribe to <span className="text-[#a1a1aa] font-medium">The Crossover</span> — weekly AI + WBB newsletter by Nicole Fetchko
              </span>
            </label>
        ...
        <p className="text-center text-sm text-[#52525b] mt-5">
          ...
          <Link href="/auth/login" className="text-[#d4a017] hover:underline font-medium">Sign in</Link>
        </p>
        <p className="text-center text-xs text-[#3f3f46] mt-2">
          Safe space for women&apos;s basketball fans. Always.
        </p>
      </motion.div>
    </div>
  )
